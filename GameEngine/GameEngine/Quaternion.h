...
public:
    ...
    ///
    static Quaternion rotationAndVectorToQuatDegrees(float degrees, glm::vec3 axis);
    ...
    ///                 Vector axis where the rotation is around.
    ///
    static Quaternion rotationAndVectorToQuatRadians(float radians, glm::vec3 axis);
    ...
    ///                 Vector axis.
    ///
    void toRotationAndVectorDegrees(float &degrees, glm::vec3 &axis);
    ...
    ///                 Vector axis.
    ///
    void toRotationAndVectorRadians(float &radians, glm::vec3 &axis);
    ...
    ///
    /// Using http://www.euclideanspace.com/maths/geometry/rotations/conversions/quaternionToEuler/ 
    /// as a reference.
    ///
    /// @param[out]     yaw
    ///                 z angle.
    ...
    ///                 x angle.
    ///
    void quatToEulerRadians(float &yaw, float &pitch, float &roll);
    ...
    ///                 x angle.
    ///
    void quatToEulerDegrees(float &yaw, float &pitch, float &roll);
