    ...
    TextureType textureType)
{
    try
    {
        if (get(name) == nullptr)
        {
            ...
            texture->textureStorageType = TextureStorageType::SINGLE;
    ...
    const std::string &positiveZTexturePath)
{
    try
    {
        if (get(name) == nullptr)
        {
            ...
            texture->textureType = TextureType::SKYBOX;
            texture->textureStorageType = TextureStorageType::CUBEMAP;
            glGenTextures(1, &texture->textureID);
...
TextureType 
TextureManager::convertFromAssimpTextureType(aiTextureType in)
{
    switch (in)
    {
...
string 
TextureManager::convertTextureTypeToString(TextureType in)
{
    switch (in)
    {
